...
import { Consumer } from '../../context';
 ...
 class Search extends Component {
     ...
     findTrack = (dispatch, e) => {
        ...
        axios
         .get(
             `https://cors-anywhere.herokuapp.com/https://api.musixmatch.com/ws/1.1/track.search?q_track=${this.state.trackTitle}&page_size=10&page=1&s_track_rating=desc&apikey=e7f00332f93eb1ec9fa52f93038ba907`)
